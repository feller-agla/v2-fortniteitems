...
export default function RegisterPage() {
  ...
  return (
    <main className="min-h-screen bg-[#091C3E] text-white selection:bg-fortnite-yellow/30 relative overflow-hidden">
      ...
      <div className="absolute top-1/4 right-1/4 w-[300px] h-[300px] bg-fortnite-yellow/10 rounded-full blur-[100px] mix-blend-screen pointer-events-none" />
      <div className="absolute bottom-1/4 left-1/4 w-[400px] h-[400px] bg-rarity-rare/20 rounded-full blur-[120px] mix-blend-screen pointer-events-none" />
      ...
      <section className="pt-32 pb-20 relative z-10 w-full flex items-center justify-center min-h-screen">
        ...
        >
          ...
          {success ? (
            ...
            <>
              {/* Google Button */}
              <button onClick={handleGoogle} className="w-full flex items-center justify-center gap-3 mb-6 py-3 px-4 bg-white text-gray-800 font-bold rounded-xl hover:bg-gray-100 transition-colors shadow-[0_4px_0_rgba(0,0,0,0.3)] hover:shadow-[0_2px_0_rgba(0,0,0,0.3)] active:shadow-none active:translate-y-1 border border-gray-200">
