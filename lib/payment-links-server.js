...
export function getDefaultPaymentLinks() {
  return {
...
export function getPaymentLinksSync() {
  try {
...
export function getPaymentLink(vbucks) {
  const links = getPaymentLinksSync();
  return links[vbucks] || `https://votre-lien-de-paiement.com/default?vbucks=${vbucks}`;
}
